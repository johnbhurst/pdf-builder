...
new PDFBuilder(new FileOutputStream("build/examples/in_action/chapter11/DeviceColor.pdf")).document() {
  writer.directContent.with {
    [
      ...
      setColorFill(new GrayColor(it[0]))
      rectangle(it[1], it[2], it[3], it[4])
      fillStroke()
    }
    [
      [0     ,  36, 716, 36, 36],
    ...
    [
      ...
      setColorFill(new Color(it[0], it[1], it[2]))
      rectangle(it[3], it[4], it[5], it[6])
      fillStroke()
    }
    [
      ...
      setRGBColorFill(it[0], it[1], it[2])
      rectangle(it[3], it[4], it[5], it[6])
      fillStroke()
    }
    [
      ...
      setRGBColorFillF(it[0], it[1], it[2])
      rectangle(it[3], it[4], it[5], it[6])
      fillStroke()
    }
    [
      ...
      setColorFill(new CMYKColor(it[0], it[1], it[2], it[3]))
      rectangle(it[4], it[5], it[6], it[7])
      fillStroke()
    }
    [
      ...
      setCMYKColorFill(it[0], it[1], it[2], it[3])
      rectangle(it[4], it[5], it[6], it[7])
      fillStroke()
    }
    [
      ...
      setCMYKColorFillF(it[0], it[1], it[2], it[3])
      rectangle(it[4], it[5], it[6], it[7])
      fillStroke()
    }
  }
